...
AddEventHandler('playerDropped', function(reason)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'joinleave', 'Player Logs', 'red', '**' .. GetPlayerName(src) .. ' | '..src..' |  left**\n['..(QBCore.Functions.GetIdentifier(src, 'steam') or 'undefined') ..']\n[' ..(QBCore.Functions.GetIdentifier(src, 'discord') or 'undefined') ..']\n**Reason:** ' .. reason)
    TriggerEvent('qb-log:server:CreateLog', 'logdiscordd4rr', 'Player Logs', 'red', '**' .. GetPlayerName(src) .. ' | '..src..' |  left**\n['..(QBCore.Functions.GetIdentifier(src, 'steam') or 'undefined') ..']\n[' ..(QBCore.Functions.GetIdentifier(src, 'discord') or 'undefined') ..']\n**Reason:** ' .. reason)
...
DWASCore.Functions.CreateCallback('QBCore:Server:SpawnVehicle', function(source, cb, model, coords, warp)
...
DWASCore.Functions.CreateCallback('QBCore:Server:CreateVehicle', function(source, cb, model, coords, warp)
    model = type(model) == 'string' and joaat(model) or model
...
--DWASCore.Functions.CreateCallback('QBCore:HasItem', function(source, cb, items, amount)
