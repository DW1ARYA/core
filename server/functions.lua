...
function QBCore.Functions.GetIdentifier(source, idtype)
    if idtype == 'license' or idtype == 'license2' then idtype = 'steam' end
    if idtype == 'lisensi' then idtype = 'license' end
    if idtype == 'lisensi2' then idtype = 'license2' end
...
-- Server Callback
function DWASCore.Functions.CreateCallback(name, cb)
